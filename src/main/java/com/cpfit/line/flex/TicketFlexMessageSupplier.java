...
public class TicketFlexMessageSupplier implements Supplier<FlexMessage> {
    ...
    private Image createHeroBlock() throws URISyntaxException {
        return Image.builder()
                .url(new URI("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/movie.png"))
    ...
    private Box createPreviewBox() throws URISyntaxException {
    ...
    private Box createQRCodeBox() throws URISyntaxException {
        final Spacer spacer = Spacer.builder().build();
        final Image qrImage = Image.builder()
                .url(new URI("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/qrcode.png"))
                .aspectMode(Image.ImageAspectMode.Cover)
