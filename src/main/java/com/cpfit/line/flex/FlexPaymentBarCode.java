...
public class FlexPaymentBarCode implements Supplier<FlexMessage>{
	...
	public FlexMessage get(String Userid,String Price , String ReDate ,int FileId) throws URISyntaxException, ClientProtocolException, IOException {
        final Image heroBlock = createHeroBlock(Userid);
        final Box bodyBlock = createBodyBlock(Price  , ReDate,FileId);
        ...
        return new FlexMessage("Counter Service", bubbleContainer);
...
if(step.equals("true")) {
	 ...
	 return Image.builder()
	   ...
	   private Box createBodyBlock(String Price, String ReDate,int FileId) throws URISyntaxException {
...
//	                .build();
		   DecimalFormat decimalFormat = new DecimalFormat("#.##");
	        ...
	        Text textamount = Text.builder()
	                //.text("ยอดค้างชำระ  ฿"+decimalFormat.format(Float.parseFloat(Price)))
	        		 .text("ยอดค้างชำระ  ")
	                .weight(Text.TextWeight.BOLD)
	      ...
	      //  Price="1000000000.00";
	       ...
	       /* if(Price.length()<7) {
	        	amount = Text.builder()
		                .text("ยอดค้างชำระ  ฿"+decimalFormat.format(Float.parseFloat(Price)))
		        		// .text("ยอดค้างชำระ  ฿"+decimalFormat.format(1000000000.00))
		                .weight(Text.TextWeight.BOLD)
		                .size(FlexFontSize.LG)
		                .build();
	        }else{*/
	        	amount = Text.builder()
		                //.text("ยอดค้างชำระ  ฿"+decimalFormat.format(Float.parseFloat(Price)))
		        		 .text("฿"+decimalFormat.format(Float.parseFloat(Price)))
		                .weight(Text.TextWeight.BOLD)
		                .size(FlexFontSize.XL)
		                .color("#10a50d")
	        ...
	        final Text duedate = Text.builder()
	        	...
	        	final Image qrcode=Image.builder()
	        			...
	        			// .url(new URI("https://km.mhesi.go.th/sites/default/files/Barcode_%E0%B8%9A%E0%B8%B2%E0%B8%A3%E0%B9%8C%E0%B9%82%E0%B8%84%E0%B9%89%E0%B8%94.jpg"))
	        			 /////// test /////
	        	...
	        	if(Price.length()<7) {
	        		return Box.builder()
			               ...
			               // .contents(asList(title,review,qrcode))
			                .contents(asList(amount,duedate,qrcode))
			                .build();	
	        	}
	        	...
	        	return Box.builder()
		                .layout(FlexLayout.VERTICAL)
		               // .contents(asList(title,review,qrcode))
		                .contents(asList(textamount,amount,duedate,qrcode))
		                .build();	
