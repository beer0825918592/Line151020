...
public class CatalogueFlexMessageSupplier implements Supplier<FlexMessage> {
    ...
    public FlexMessage get() {
		...
		try {
			Bubble bubble1;
			bubble1 = createBubble("Arm Chair, White",
			        "49.99",
    ...
    private Bubble createBubble(String title, String price, String imageURL, Boolean isOutOfStock) throws URISyntaxException {
    ...
    private Bubble createSeeMoreBubble() throws URISyntaxException {
        return Bubble.builder()
                .body(Box.builder()
                        ...
                        .contents(asList(
                                Button.builder()
                                        ...
                                        .action(new URIAction("See more1",new URI("http://example.com"),new AltUri(new URI("http://example.com"))))
    ...
    private Image createHeroBlock(String imageURL) throws URISyntaxException {
    ...
    private Box createFooterBlock(Boolean isOutOfStock) throws URISyntaxException {
        ...
        final Button addToWishlistButton = Button.builder()
               // .action(new URIAction("Add to wishlist", "http://example.com"))
                .action(new URIAction("Add to wishlist",new URI("http://example.com"),new AltUri(new URI("http://example.com"))))
                .build();
        return Box.builder()
                .layout(FlexLayout.VERTICAL)
                .spacing(FlexMarginSize.SM)
